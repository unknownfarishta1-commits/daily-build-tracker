  ...
  head: () => ({
    meta: [
      ...
      { title: "ABTalks — 60-Day Build Challenge" },
      {
        name: "description",
        content:
          "ABTalks runs a 60-day build challenge for Indian college students. One build a day, proven with GitHub and LinkedIn.",
      },
      { name: "author", content: "ABTalks" },
      { property: "og:title", content: "ABTalks — 60-Day Build Challenge" },
      {
        property: "og:description",
        content: "60 days. 60 builds. One strong portfolio.",
      },
